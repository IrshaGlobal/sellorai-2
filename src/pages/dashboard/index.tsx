        ...
        <main className="p-6">
          ...
          <div className="bg-white shadow rounded-lg p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/dashboard/products/new" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                Add New Product
              </Link>
              <a href={`https://${mockData.storeUrl}`} target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors">
                View Your Store
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-3xl font-bold">${mockData.totalSales.toFixed(2)}</p>
              <p className="text-sm text-gray-500 mt-2">Lifetime sales</p>
            </div>
            
            <div className="bg-white shadow rounded-lg p-6">
              <h3 className="text-sm font-medium text-gray-500 mb-1">Total Orders</h3>
              <p className="text-3xl font-bold">{mockData.totalOrders}</p>
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/dashboard/products/new" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors flex flex-col items-center text-center">
              ...
              <Link href="/dashboard/settings" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors flex flex-col items-center text-center">
                <svg className="h-8 w-8 text-blue-500 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <Link href="/dashboard/settings#payment" className="p-4 border rounded-lg hover:bg-gray-50 transition-colors flex flex-col items-center text-center">
                <svg className="h-8 w-8 text-blue-500 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
